...
struct MOUSEINFO {
        ...
        struct {
				...
				uint8_t bmSideButtonUp : 1;
                uint8_t bmSideButtonDown : 1;
                uint8_t bmDummy : 3;
        };
        int8_t dX;
        int8_t dY;
...
protected:
		...
		virtual void OnSideButtonUpUp(MOUSEINFO *mi __attribute__((unused))) {
        };

        virtual void OnSideButtonUpDown(MOUSEINFO *mi __attribute__((unused))) {
        };
		
		virtual void OnSideButtonDownUp(MOUSEINFO *mi __attribute__((unused))) {
        };

        virtual void OnSideButtonDownDown(MOUSEINFO *mi __attribute__((unused))) {
        };
};
